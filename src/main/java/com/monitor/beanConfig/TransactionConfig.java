...
@Aspect
@Configuration
//@EnableTransactionManagement// 启动注解事务管理，等同于xml配置方式的 <tx:annotation-driven />，此处使用切面配置方式
public class TransactionConfig {
	private static final int TX_METHOD_TIMEOUT = 5;
	/*定义切面表达式：拦截dao包下所有类的所有方法,返回值类型任意的方法*/
	...
	public TransactionInterceptor txAdvice() {
		...
		txAttr_REQUIRED.setTimeout(TX_METHOD_TIMEOUT);/*设置事务失效时间，如果超过5秒，则回滚事务*/
		...
		txAttr_REQUIRED_READONLY.setReadOnly(true);/*设置当前事务是否为只读事务，true为只读*/
