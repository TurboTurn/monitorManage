...
public class HttpWriter {//数据采集程序，部署到库区，将数据上传
	...
	public void write(){//将数据发送到http接口
		...
		Tank t1 = new Tank(time,"tank1","丙烷",true,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				pressure + random.nextInt(3) * 0.001,
				temperature + random.nextInt(3) * 0.1);
		Tank t2 = new Tank(time,"tank2","丙烷",true,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				pressure + random.nextInt(3) * 0.001,
				temperature + random.nextInt(3) * 0.1);
		Tank t3 = new Tank(time,"tank3","丙烷",true,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				pressure + random.nextInt(3) * 0.001,
				temperature + random.nextInt(3) * 0.1);
		Tank t4 = new Tank(time,"tank4","丁烷",true,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				pressure + random.nextInt(3) * 0.001,
				temperature + random.nextInt(3) * 0.1);
		Tank t5 = new Tank(time,"tank5","丁烷",true,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				pressure + random.nextInt(3) * 0.001,
				temperature + random.nextInt(3) * 0.1);
		Tank t6 = new Tank(time,"tank6","丁烷",true,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				height + random.nextInt(3) * 0.001,
				pressure + random.nextInt(3) * 0.001,
